...
public class StandardHardware {
    ...
    public StandardHardware() {
        ...
        jc = new StandardJanelaCafeteira(this);
    }
    ...
    class Serpentina extends Thread {
        ...
        private StandardHardware cafeteira;

        public Serpentina(StandardHardware oHardware) {
            cafeteira = oHardware;
        }
