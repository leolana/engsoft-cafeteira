...
public class StandardJanelaCafeteira extends JFrame 
        implements ChangeListener, ActionListener, ItemListener {
    
    private static final long serialVersionUID = -765097671714426223L;

    private StandardHardware hardware;
    ...
    public StandardJanelaCafeteira(StandardHardware oHardware) {
        super();
        hardware = oHardware;
        ready = false;
    }
